...
$consulta = $connection->query('select p.id_pedido, fecha, precio, observaciones, nombre from pedido p, entrada_pedido ep, producto pr where p.id_pedido=ep.id_pedido and ep.id_producto=pr.id_producto and p.id_usuario in (select id_usuario from usuario where correo="carlos1m2r3@hotmail.com")');
