	...
	<!-- Fin LOGIN-REGISTRO -->
		...
		<div id="encabezado">
          ...
          <?PHP
            ...
            if(isset($_SESSION['permisos']) && $_SESSION['permisos']['pedidos'][0]){
          ?>
            <div class="desp26" style="background-color:#0C5484;color:#ffffff;">
      ...
      <div id="row2">
        ...
        <div class="subrow1"><br>
            ...
            <div>
            <ul>
              <li><a href="tema.php?tema=azul">Azul</a></li>
              <li><a href="tema.php?tema=verde">Verde</a></li>
              <li><a href="tema.php?tema=rojo">Rojo</a></li>
            </ul>
            </div>
        </div>
        <div id="subrow21">
